...
public class PropertieUtil {
	...
	public static Properties getProps(String propsName) {
		...
		try {
			File f_file = new File(
					URLDecoder.decode(PropertieUtil.class.getClassLoader().getResource(propsName+".properties").getFile(), "iso-8859-1"));
	...
	public static String getStrProp(String propsName, String propName, String defaultValue) {
		String value = getStrProp(propsName, propName);
		return value == null || value.trim().length() < 1 ? defaultValue : value;
	}
	...
	public static void main(String[] args) {
		System.out.println(PropertieUtil.getStrProp("resource", "ZK_LOCK_HOST", "10.100.20.134:2181"));
	}
}
